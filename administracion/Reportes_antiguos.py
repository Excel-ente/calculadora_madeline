...
def generar_presupuesto(modeladmin, request, queryset):
    ...
    if logo_path:
        ...
        logo_y = 900  # Posición vertical del logo
    ...
    #Redes sociales
    p.setFont("Helvetica-Bold", 9)  # Fuente en negrita
    p.drawString(x, y, "Direccion: ")
    p.setFont("Helvetica", 9)  # Fuente normal
    p.drawString(100, y, direccion_empresa)
    y -= 15

    p.setFont("Helvetica-Bold", 9)  # Fuente en negrita
    p.drawString(x, y, "Telefono: ")
    p.setFont("Helvetica", 9)  # Fuente normal
    p.drawString(100, y, telefono_empresa)
    y -= 15

    p.setFont("Helvetica-Bold", 9)  # Fuente en negrita
    p.drawString(x, y, "Mail: ")
    p.setFont("Helvetica", 9)  # Fuente normal
    p.drawString(100, y, email_empresa)
    y -= 15
    ...
    #S i quiero mostrar la direccion del cliente descomentar<>
    #p.setFont("Helvetica-Bold", 10)  # Fuente en negrita
    #p.drawString(x, y, "Direccion: ")
    #p.setFont("Helvetica", 10)  # Fuente normal
    ...
    if pedido.ESTADO == "Pendiente":
        ...
        p.drawString(110, 20, f"Presupuesto no aceptado - válido hasta el {pedido.VALIDO_HASTA.strftime('%A %d de %B del %Y')}")
    else:
        p.setFont("Helvetica-Bold", 12)
        p.drawString(220, 20, f"PRESUPUESTO ACEPTADO")
